          ...
          <div className="container mx-auto px-4 py-20">
            <div className="max-w-3xl">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-2xl">
                Discover thousands of movies and TV shows. Stream instantly, watch with friends,
                and join a community of entertainment lovers.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 items-start">
                {!user ? (
                  <>
                    <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white shadow-xl hover:shadow-red-500/25 transition-all">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              From blockbuster hits to hidden gems, find exactly what you're looking for
            </p>
          </div>
      ...
      <main className="container mx-auto px-4 space-y-12 pb-16">
        ...
        <section className="bg-gray-900/50 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-red-400 mb-2">2M+</div>
