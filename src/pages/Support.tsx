...
import { Heart, Coffee, Star, Users, Zap, Shield } from 'lucide-react';
...
const Support = () => {
  ...
  const handleDonate = (amount: number) => {
    ...
    toast({
      ...
      description: `We appreciate your ${amount === 0 ? 'custom' : '$' + amount} donation. Payment integration coming soon!`,
    });
  };
