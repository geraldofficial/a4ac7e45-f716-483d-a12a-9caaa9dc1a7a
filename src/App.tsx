            ...
            <AuthProvider>
              <div className="min-h-screen bg-gray-950">
                ...
                <Routes>
                  ...
                  <Route path="/admin" element={<SafeRoute componentName="Admin"><Admin /></SafeRoute>} />
                  ...
                  <Route path="/watch-party/:partyId" element={<SafeRoute componentName="Watch Party"><WatchParty /></SafeRoute>} />
